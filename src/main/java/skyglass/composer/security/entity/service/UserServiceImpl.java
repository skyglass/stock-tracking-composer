...
public class UserServiceImpl implements UserService {
	...
	public UserDTO createUser(UserDTO userDto) {
		...
		OwnerEntity owner = ownerRepository.findByUuidSecure(userDto.getOwnerUuid());
		UserEntity entity = new UserEntity(null, userDto.getUsername(), null, userDto.getEmail(), userDto.getFirstName() + userDto.getLastName(), owner);
