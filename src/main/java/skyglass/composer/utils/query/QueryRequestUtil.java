...
public class QueryRequestUtil {
	...
	public static String getCurrentLanguageCode(QueryRequestDTO queryRequest) {
		return queryRequest == null || StringUtils.isBlank(queryRequest.getLang()) ? Language.DEFAULT.getLanguageCode()
				: Language.getByLanguageCode(queryRequest.getLang()).getLanguageCode();
	}
