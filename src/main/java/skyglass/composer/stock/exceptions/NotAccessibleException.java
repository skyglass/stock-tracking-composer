...
public class NotAccessibleException extends ClientException {
	...
	public NotAccessibleException(@NotNull IdObject object) {
		this(object, null);
	}

	public NotAccessibleException(@NotNull IdObject object, Throwable cause) {
		this(object.getClass(), object.getUuid(), cause);
	}

	public NotAccessibleException(Class<? extends IdObject> type) {
		this(type, (Throwable) null);
	}

	public NotAccessibleException(Class<? extends IdObject> type, Throwable cause) {
		this(type, null, cause);
	}

	public NotAccessibleException(Class<? extends IdObject> type, String uuid) {
		this(type, uuid, null);
	}

	public NotAccessibleException(Class<? extends IdObject> type, String uuid, Throwable cause) {
		this(null, type, uuid, cause);
	}

	public NotAccessibleException(Class<? extends IdObject> subType, Class<? extends IdObject> type,
			String uuid) {
	...
	public NotAccessibleException(Class<? extends IdObject> subType, boolean singleSubType,
			Class<? extends IdObject> type, String uuid) {
		this(subType, singleSubType, type, uuid, null);
	}

	public NotAccessibleException(Class<? extends IdObject> subType, boolean singleSubType,
			Class<? extends IdObject> type, String uuid, Throwable cause) {
		this(buildMessage(subType, singleSubType, type, uuid), cause);
	}

	@SafeVarargs
	public NotAccessibleException(Class<? extends IdObject> type, Pair<String, String>... criterias) {
	...
	@SafeVarargs
	public NotAccessibleException(Class<? extends IdObject> type, boolean single,
			Pair<String, String>... criterias) {
		this(type, single, null, criterias);
	}

	@SafeVarargs
	public NotAccessibleException(Class<? extends IdObject> type, boolean single, Throwable cause,
			Pair<String, String>... criterias) {
	...
	private static String buildMessage(Class<? extends IdObject> subType, boolean singleSubType,
			Class<? extends IdObject> type, String uuid) {
