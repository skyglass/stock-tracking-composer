...
public class NotAllowedException extends NotAccessibleException {
	...
	public NotAllowedException(@NotNull IdObject entity) {
		this(entity, null);
	}

	public NotAllowedException(@NotNull IdObject entity, Throwable cause) {
	...
	@SafeVarargs
	public NotAllowedException(Class<? extends IdObject> entityType, Pair<String, String>... criterias) {
		this(entityType, null, criterias);
	}

	@SafeVarargs
	public NotAllowedException(Class<? extends IdObject> entityType, Throwable cause,
			Pair<String, String>... criterias) {
		this(buildMessage(entityType, criterias), cause);
	}

	public NotAllowedException(Class<? extends IdObject> entityType) {
	...
	public NotAllowedException(Class<? extends IdObject> entityType, String uuid) {
		this(entityType, uuid, null);
	}

	public NotAllowedException(Class<? extends IdObject> entityType, String uuid, Throwable cause) {
	...
	private static String buildMessage(Class<? extends IdObject> type, String uuid) {
	...
	@SafeVarargs
	private static String buildMessage(Class<? extends IdObject> type, Pair<String, String>... criterias) {
		String typeName = "";
		if (type != null) {
			typeName = type.getSimpleName();
		}
